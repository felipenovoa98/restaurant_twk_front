...
<div class="container">
  <form action="/action_page.php">
    <div class="row">
         ...
         <br>
         <br>
      <h1 style ="text-align:center">Entra mediante una RED SOCIAL <br>
         o con tu CUENTA</h1>
         <br>
      ...
      <div class="col"><br>
        ...
        <a href="#" class="twitter btn">
          <i class="fa fa-twitter fa-fw"></i> Login con Twitter 
        </a><br><br>
    ...
    <router-link to="/hola">Entrar</router-link> 
...
<div class="bottom-container">
  <div class="row">
    ...
    <div class="col">
      ...
      <router-link style="color:white" class="regUser" to="/register">Registrate gratis!</router-link>
    </div>
  </div>
  <br>
  <br>
